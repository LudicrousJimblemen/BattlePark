...
public class TitleScreenGUI : MonoBehaviour {
	...
	private void Awake() {
		StartServerButton.GetComponentInChildren<Text>().text = LanguageManager.GetString("titleScreen.startServer");
		StartClientButton.GetComponentInChildren<Text>().text = LanguageManager.GetString("titleScreen.startClient");
